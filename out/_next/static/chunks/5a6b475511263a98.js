...
to {
  ...
  animation: ${K} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Y=({toast:e})=>{let{icon:t,type:a,iconTheme:r}=e;return void 0!==t?"string"==typeof t?o.createElement(q,null,t):t:"blank"===a?null:o.createElement(B,null,o.createElement(M,{...r}),"loading"!==a&&o.createElement(U,null,"error"===a?o.createElement(F,{...r}):o.createElement(R,{...r})))},Z=h("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
